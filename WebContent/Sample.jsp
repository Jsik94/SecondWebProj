...
<html lang="ko">
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="<c:url value="/resource/"/>assets/favicon.ico" />
        <!-- Bootstrap icons-->
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            <div class="container px-5">
                <a class="navbar-brand" href="#!"><i class="fa fa-home fa-fw" aria-hidden="true"></i> Project Home</a>
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <h1 class="display-5 fw-bolder text-white mb-2"> 여기에 크루샬 박자</h1>
